...
from Code.Cards.Offense.cards_offense import (
    Strike, Slash, HeavyStrike  # Execute, PoisonStrike, AreaAttack - no unique images
)
from Code.Cards.Defense.cards_defense import (
    ShieldUp, Dodge, Regeneration, Heal  # ArmorUp, CounterAttack, Parry - no unique images
)
# All utility cards commented out - no unique images
